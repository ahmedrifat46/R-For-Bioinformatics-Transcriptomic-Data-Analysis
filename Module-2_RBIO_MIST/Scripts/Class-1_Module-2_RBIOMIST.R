# ==========================================================================
# COURSE: R for Bioinformatics & Transcriptomic Data Analysis
#                   MODULE 2 Class 1
# ==========================================================================
...
# gse_data <- getGEO("GSE79973", GSEMatrix = TRUE)
 # OR Pre-downloaded series matrix
gse_data <- getGEO(filename = "F:/R_for_Bioinfo_May_2026/Module2/GSE79973_series_matrix.txt.gz", GSEMatrix = TRUE)
...
untar("GSE79973_RAW.tar", exdir = "CEL_Files")

# Alternatively, unzip if data is compressed as .zip
# unzip("E-GEOD-79973.zip", exdir = "E_GEOD79973")
...
# arrayQualityMetrics: 
# This package generates automated QC reports for microarray data.
